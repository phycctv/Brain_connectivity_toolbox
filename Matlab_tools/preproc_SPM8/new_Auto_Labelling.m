...
% Version $1.0
%__________________________________________________________________________
% Modified for spm8 new segmentation deformation fields by Manuel Wuthrich 18.10.2010
...
ofnames = fullfile(outputDir,[nam,'_Atlas',ext]);
...
atlasedVol.fname =[char(outputDir) filesep Vname '_Atlas' Vext];
atlasedVol = spm_create_vol(atlasedVol);
